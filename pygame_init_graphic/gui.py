...
def draw_gui():
    ...
    draw_panel_row("Temp", get_global_var("temp"), 142)
    draw_panel_row("Sim ms", format_ms(get_global_var("simulation_ms")), 182)
    draw_panel_row("Draw ms", format_ms(get_global_var("draw_ms")), 222)
    draw_panel_row("Rects", get_global_var("drawn_objects"), 262)
    draw_panel_row("FPS", int(clock.get_fps()), 302)
