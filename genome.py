...
class BotGenome:
    ...
    def execute_genome(self):
        ...
        self.food -= func.normalize_value(temp, -15, 15, 20, 10)
    ...
    def how_many_food(self):
        ...
        next_next_ptr_index = (
            self.ptr + 3 + func.normalize_value(temp, -15, 15, 3, 6)) % len(self.genome)
    ...
    def move(self):
        ...
        _, sun_dist = self.food_consumption()
        ...
        # Если куда хочет шагнуть клетка есть еда
            ...
            dir_index = (
                self.ptr + 3 + int(func.normalize_value(self.food, 0, 1000, 1, 10))) % len(self.genome)
    ...
    def is_this_temp(self):
        temp_index = (
            self.ptr + int(func.normalize_value(temp, -15, 15, 1, 100))) % len(self.genome)
